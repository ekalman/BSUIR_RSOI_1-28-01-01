...
(function (a, b) {
  ...
  bM = bH.exec(bL.toLowerCase()) || [], d.fn.extend({
    ...
    ajax: function (a, c) {
      ...
      var e = d.ajaxSetup({}, c), f = e.context || e, g = f !== e && (f.nodeType || f instanceof d) ? d(f) : d.event,
        h = d.Deferred(), i = d._Deferred(), j = e.statusCode || {}, k, l = {}, m, n, o, p, q, r = 0, s, t, u = {
  ...
  "getBoundingClientRect" in c.documentElement ? d.fn.offset = function (a) {
    ...
    var h = f.body, i = ci(f), j = g.clientTop || h.clientTop || 0, k = g.clientLeft || h.clientLeft || 0,
      ...
      m = i.pageXOffset || d.support.boxModel && g.scrollLeft || h.scrollLeft, n = c.top + l - j, o = c.left + m - k;
    return {top: n, left: o}
